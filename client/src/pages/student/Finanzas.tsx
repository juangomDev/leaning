...
export const Finanzas: React.FC = () => {
  const [balance, setBalance] = useState<number>(85.0);
  ...
  const handleRecharge = (e: React.FormEvent) => {
    e.preventDefault();
    const newBalance = balance + parseFloat(rechargeAmount);
    setBalance(newBalance);
    setRechargeModal(false);
    alert(`¡Recarga exitosa de $${rechargeAmount} USD! Tu nuevo saldo es $${newBalance} USD.`);
  };
