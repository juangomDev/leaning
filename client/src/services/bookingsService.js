...
export const bookingsService = {
  ...
  async createBooking(booking) {
    // 1. Try Clean Architecture Backend
    try {
      const backendRes = await backendClient.post(
        '/bookings',
        {
  ...
  async updateBookingStatus(bookingId, newStatus, userId = null, role = null) {
    // 1. Try Clean Architecture Backend
    try {
      const backendRes = await backendClient.patch(
